...
agg <- aggregate(completedData[,14:21] , by = list(tagid=completedData$tagid,wave=completedData$wave),FUN= mean) #for continuous variables
...
#Wave 1
Timing_allways1 <- Timing_neg1_resid %>% select(resid_neg_EST_cor_wave1,resid_neg_TEST_cor_wave1,resid_neg_DHEA_cor_wave1,aam_final,parent_subj_timing_wave1,subj_timing_wave1,resid_neg_ADRENcomp_wave1,resid_neg_GONADcomp_wave1,resid_neg_PUBcomp_wave1,resid_neg_ldstage_wave1,resid_neg_parent_pdsstage_wave1,resid_neg_pdsstage_wave1)
...
colnames(cor_timing1_r) <- c("Residualized estradiol", "Residualized testosterone", "Residualized DHEA", "Age at menarche", "Parent-report subjective timing", "Self-report subjective timing", "Residualized adrenal composite", "Residualized gonadal composite", "Residualized puberty composite", "Residualized LD stage", "Residualized parent-report PDS stage", "Residualized self-report PDS stage")
...
#Wave 2
Timing_allways2 <- Timing_neg1_resid %>% select(resid_neg_EST_cor_wave2,resid_neg_TEST_cor_wave2,resid_neg_DHEA_cor_wave2,aam_final,parent_subj_timing_wave2,subj_timing_wave2,resid_neg_ADRENcomp_wave2,resid_neg_GONADcomp_wave2,resid_neg_PUBcomp_wave2,resid_neg_ldstage_wave2,resid_neg_parent_pdsstage_wave2,resid_neg_pdsstage_wave2)
