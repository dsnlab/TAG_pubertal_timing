...
# NOTE: Run the dynamic timing window script after this - it calculates timing based on stage of windows of 6 month age peers per person. This script is separate and will be used for descriptive purposes only (since they correlate strongly with age residuals)
```
