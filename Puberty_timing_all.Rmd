...
#Wave 1
Timing_allways1 <- Timing_allways %>% select(resid_pdsstage_wave1,resid_parent_pdsstage_wave1,resid_ldstage_wave1,resid_PUBcomp_wave1,resid_ADRENcomp_wave1,resid_GONADcomp_wave1,subj_timing_wave1,parent_subj_timing_wave1,resid_DHEA_cor_wave1,resid_TEST_cor_wave1,resid_EST_cor_wave1,aam_final)
...
ggcorrplot(cor_timing1_r, p.mat=p_timing1_r, lab=T,lab_size=3,type="lower",title="Pubertal timing correlations Time 1")

#Wave 2
Timing_allways2 <- Timing_allways %>% select(resid_pdsstage_wave2,resid_parent_pdsstage_wave2,resid_ldstage_wave2,resid_PUBcomp_wave2,resid_ADRENcomp_wave2,resid_GONADcomp_wave2,subj_timing_wave2,parent_subj_timing_wave2,resid_DHEA_cor_wave2,resid_TEST_cor_wave2,resid_EST_cor_wave2,aam_final)
...
ggcorrplot(cor_timing2_r, p.mat=p_timing2, lab=T, lab_size=3,type="lower", title="Pubertal timing correlations Time 2")
...
ggcorrplot(cor_timing_r, p.mat=p_timing, lab=T,lab_size=2,type="lower", title="Pubertal timing correlations both waves")
