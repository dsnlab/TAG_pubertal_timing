...
ggcorrplot(cor_timing1_r, lab=T,lab_size=4,type="lower",title="Pubertal timing correlations Time 1",colors = c("#e41a1c", "white", "#6897bb"))
...
ggcorrplot(cor_timing2_r, lab=T, lab_size=4,type="lower", title="Pubertal timing correlations Time 2",colors = c("#e41a1c", "white", "#6897bb"))
...
exp_aam_cesd <- summary(lm(CESDC_total_im_wave2 ~ exp(aam_final) + CESDC_total_im_wave1 + CTQ_threat_im_wave2, AAM_nl_tests))

linear_aam_scared <- summary(lm(SCARED_mean_im_wave2 ~ aam_final + SCARED_mean_im_wave1 + CTQ_threat_im_wave2, AAM_nl_tests))
exp_aam_scared <- summary(lm(SCARED_mean_im_wave2 ~ exp(aam_final) + SCARED_mean_im_wave1 + CTQ_threat_im_wave2, AAM_nl_tests))
```
