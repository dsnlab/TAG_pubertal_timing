...
#create residuals for each wave separately
...
for(Pub in pubcolumns1){
  ...
  summary(modelap1)
  Puberty_allways_short[[paste('resid',Pub, sep="_")]] <- resid(modelap1)
}
...
for(Pub in pubcolumns2){
  ...
  summary(modelap2)
  Puberty_allways_short[[paste('resid',Pub, sep="_")]] <- resid(modelap2)
}

write.csv(Puberty_allways_short, paste0(cas_dir, "projects/W1_W2_pubertal_timing/Timing_allways_short.csv"),row.names = F)
