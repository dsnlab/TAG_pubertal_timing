...
resid_vars <- c("resid_ldstage_wave1", "resid_pdsstage_wave1", "resid_ADRENcomp_wave1", "resid_GONADcomp_wave1", "resid_PUBcomp_wave1", "resid_parent_pdsstage_wave1", "resid_DHEA_cor_wave1", "resid_TEST_cor_wave1", "resid_EST_cor_wave1", "resid_ldstage_wave2", "resid_pdsstage_wave2", "resid_ADRENcomp_wave2", "resid_GONADcomp_wave2", "resid_PUBcomp_wave2", "resid_parent_pdsstage_wave2", "resid_DHEA_cor_wave2", "resid_TEST_cor_wave2", "resid_EST_cor_wave2")
resid_vars_im <- c("resid_ldstage_im_wave1", "resid_pdsstage_im_wave1", "resid_ADRENcomp_im_wave1", "resid_GONADcomp_im_wave1", "resid_PUBcomp_im_wave1", "resid_DHEA_cor_im_wave1", "resid_TEST_cor_im_wave1", "resid_EST_cor_im_wave1", "resid_ldstage_im_wave2", "resid_pdsstage_im_wave2", "resid_ADRENcomp_im_wave2", "resid_GONADcomp_im_wave2", "resid_PUBcomp_im_wave2", "resid_DHEA_cor_im_wave2", "resid_TEST_cor_im_wave2", "resid_EST_cor_im_wave2")
resid_neg_vars <- c("resid_neg_ldstage_wave1", "resid_neg_pdsstage_wave1", "resid_neg_ADRENcomp_wave1", "resid_neg_GONADcomp_wave1", "resid_neg_PUBcomp_wave1", "resid_neg_parent_pdsstage_wave1", "resid_neg_DHEA_cor_wave1", "resid_neg_TEST_cor_wave1", "resid_neg_EST_cor_wave1", "resid_neg_ldstage_wave2", "resid_neg_pdsstage_wave2", "resid_neg_ADRENcomp_wave2", "resid_neg_GONADcomp_wave2", "resid_neg_PUBcomp_wave2", "resid_neg_parent_pdsstage_wave2", "resid_neg_DHEA_cor_wave2", "resid_neg_TEST_cor_wave2", "resid_neg_EST_cor_wave2")
resid_neg_vars_im <- c("resid_neg_ldstage_im_wave1", "resid_neg_pdsstage_im_wave1", "resid_neg_ADRENcomp_im_wave1", "resid_neg_GONADcomp_im_wave1", "resid_neg_PUBcomp_im_wave1", "resid_neg_DHEA_cor_im_wave1", "resid_neg_TEST_cor_im_wave1", "resid_neg_EST_cor_im_wave1", "resid_neg_ldstage_im_wave2", "resid_neg_pdsstage_im_wave2", "resid_neg_ADRENcomp_im_wave2", "resid_neg_GONADcomp_im_wave2", "resid_neg_PUBcomp_im_wave2", "resid_neg_DHEA_cor_im_wave2", "resid_neg_TEST_cor_im_wave2", "resid_neg_EST_cor_im_wave2")
Timing_neg1_resid[resid_neg_vars] <- Timing_neg1_resid[resid_vars]*-1
Timing_neg1_resid[resid_neg_vars_im] <- Timing_neg1_resid[resid_vars_im]*-1

# Now separate out the imputed and non imputed datasets and save. Both of these are with reversed residuals so their directions match subjective timing and age at menarche:
im_vars <- c("tagid", "age_im_wave1", "age_im_wave2", "pdsstage_im_wave1", "pdsstage_im_wave2", "ldstage_im_wave1", "ldstage_im_wave2", "parent_pdsstage_im_wave1", "parent_pdsstage_im_wave2", "ADRENcomp_im_wave1", "ADRENcomp_im_wave2", "GONADcomp_im_wave1", "GONADcomp_im_wave2", "PUBcomp_im_wave1", "PUBcomp_im_wave2", "subj_timing_im_wave1", "subj_timing_im_wave2", "parent_subj_timing_im_wave1", "parent_subj_timing_im_wave2", "DHEA_cor_im_wave1", "DHEA_cor_im_wave2", "TEST_cor_im_wave1", "TEST_cor_im_wave2", "EST_cor_im_wave1", "EST_cor_im_wave2", "SCARED_mean_im_wave1", "SCARED_mean_im_wave2", "CESDC_total_im_wave1", "CESDC_total_im_wave2", "depres_d_im_wave1", "depres_d_im_wave2", "anx_d_im_wave1", "anx_d_im_wave2", "int_d_im_wave1", "int_d_im_wave2", "distress_d_im_wave1", "distress_d_im_wave2", "fear_d_im_wave1", "fear_d_im_wave2", "CTQ_threat_im_wave1", "CTQ_threat_im_wave2", "aam_final", resid_neg_vars_im)
Final_timing_int_imputed <- select(Timing_neg1_resid, im_vars)
write.csv(Final_timing_int_imputed,paste0(cas_dir,'projects/W1_W2_pubertal_timing/Final_timing_int_imputed.csv'),row.names=F)

nonim_vars <- c("tagid", "age_wave2", "age_wave1", "pdsstage_wave2", "pdsstage_wave1", "ldstage_wave2", "ldstage_wave1", "parent_pdsstage_wave2", "parent_pdsstage_wave1", "ADRENcomp_wave2", "ADRENcomp_wave1", "GONADcomp_wave2", "GONADcomp_wave1", "PUBcomp_wave2", "PUBcomp_wave1", "subj_timing_wave2", "subj_timing_wave1", "parent_subj_timing_wave2", "parent_subj_timing_wave1", "DHEA_cor_wave2", "DHEA_cor_wave1", "TEST_cor_wave2", "TEST_cor_wave1", "EST_cor_wave2", "EST_cor_wave1", "SCARED_mean_wave2", "SCARED_mean_wave1", "CESDC_total_wave2", "CESDC_total_wave1", "depres_d_wave2", "depres_d_wave1", "anx_d_wave2", "anx_d_wave1", "int_d_wave2", "int_d_wave1", "distress_d_wave2", "distress_d_wave1", "fear_d_wave2", "fear_d_wave1", "CTQ_threat_wave2", "CTQ_threat_wave1", "aam_final", resid_neg_vars)
Final_timing_int_nonimputed <- select(Timing_neg1_resid, nonim_vars)
write.csv(Final_timing_int_nonimputed,paste0(cas_dir,'projects/W1_W2_pubertal_timing/Final_timing_int_nonimputed.csv'),row.names=F)
